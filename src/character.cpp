...
int Character::getLevel(string className) const {return classLevels.at(className);}
int Character::getTotalLevel() const {return totalLevel;}// FIXME set from classLevels
...
map<string, string> Character::getSkillToAbility() const {return skillToAbility;};
...
void Character::toggleProficiency(string prof) {proficiencies[prof] = !proficiencies[prof];}
