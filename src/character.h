...
class Character {
    private:
        ...
        map<string, string> skillToAbility = {
        ...
        vector<string> known_skills; // may be redundant, consider converting ability values to save and prof maps straight from JSON
...
//        void addClass(string className, int levels = 1);
        ...
        int getLevel(string className) const; // returns level of individual class from classLevels from associated name
